...
export default function DocsPage() {
  ...
  return (
    <Layout limitHeight={false}>
      <main className='w-full h-full flex flex-col items-center justify-center text-gray-800 dark:text-gray-100 p-6 bg-gray-100 dark:bg-gray-950'>
        ...
        <ExplanationCard title="Agrandar mensajes" text={'1) Ir a la barra de navegación y presionar en chats.<br />2) Elegir el chat que desee.<br />3) Al mantener presionado un mensaje cualquiera, este se agrandará.'} images={['assets/views/navbar_chat.png', 'assets/views/chat_capture.png', 'assets/views/big_chat.png']} />
        ...
        {/*<ExplanationCard title="Transformar audio a texto" text={"1) Ir a la barra de navegación y presionar en chats.<br />2) Elegir el chat que desee.<br />3) Al hacer click sobre un mensaje, una voz lo leerá."} images={["assets/views/navbar_chat.png", "assets/views/chat_capture.png", "assets/views/voice_chat.png"]} /> */}
      </main>
    </Layout>
  )
}
